...
parcelHelpers.export(exports, "searchForCocktails", ()=>searchForCocktails);
/**
 * Fonction permettant de créer la div.cocktail
 */ parcelHelpers.export(exports, "createCocktail", ()=>createCocktail);
async function searchForCocktails() {
    // On récupére la valeur de recherche
    const search = document.querySelector("#search").value;
    // Si je n'ai rien rentré
    if (!search) // On arréte la fonction
    return;
...
},{}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire5c7b")
